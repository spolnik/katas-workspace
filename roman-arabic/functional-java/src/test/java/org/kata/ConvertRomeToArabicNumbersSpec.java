...
public class ConvertRomeToArabicNumbersSpec {
    ...
    public void converts_signle_rome_number_to_arabic_number(String roman, int arabic) throws Exception {
    ...
    public void converts_multiple_rome_number_to_arabic_number(String roman, int arabic) throws Exception {
